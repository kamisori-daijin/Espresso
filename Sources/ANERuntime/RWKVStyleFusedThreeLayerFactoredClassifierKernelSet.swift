    ...
    public init(
        ...
        self.fusedStep = try ANEKernel(
            ...
            weights: [
                ...
                (path: "@model_path/weights/wx0.bin", data: Self.buildBlob(from: weights0.Wx, rows: dim, cols: dim)),
                (path: "@model_path/weights/ws0.bin", data: Self.buildBlob(from: weights0.Ws, rows: dim, cols: dim)),
                (path: "@model_path/weights/wd0.bin", data: Self.buildBlob(from: weights0.Wd, rows: dim, cols: dim)),
                (path: "@model_path/weights/wo0.bin", data: Self.buildBlob(from: weights0.Wo, rows: dim, cols: dim)),
                // Layer 1
                (path: "@model_path/weights/rwkv_rms1.bin", data: Self.buildBlob(from: weights1.rms, rows: 1, cols: dim)),
                (path: "@model_path/weights/wx1.bin", data: Self.buildBlob(from: weights1.Wx, rows: dim, cols: dim)),
                (path: "@model_path/weights/ws1.bin", data: Self.buildBlob(from: weights1.Ws, rows: dim, cols: dim)),
                (path: "@model_path/weights/wd1.bin", data: Self.buildBlob(from: weights1.Wd, rows: dim, cols: dim)),
                (path: "@model_path/weights/wo1.bin", data: Self.buildBlob(from: weights1.Wo, rows: dim, cols: dim)),
                // Layer 2
                (path: "@model_path/weights/rwkv_rms2.bin", data: Self.buildBlob(from: weights2.rms, rows: 1, cols: dim)),
                (path: "@model_path/weights/wx2.bin", data: Self.buildBlob(from: weights2.Wx, rows: dim, cols: dim)),
                (path: "@model_path/weights/ws2.bin", data: Self.buildBlob(from: weights2.Ws, rows: dim, cols: dim)),
                (path: "@model_path/weights/wd2.bin", data: Self.buildBlob(from: weights2.Wd, rows: dim, cols: dim)),
                (path: "@model_path/weights/wo2.bin", data: Self.buildBlob(from: weights2.Wo, rows: dim, cols: dim)),
                ...
                (path: "@model_path/weights/cls_proj.bin", data: Self.buildBlob(from: classifierProjection, rows: bottleneck, cols: dim)),
                (path: "@model_path/weights/cls_expand.bin", data: Self.buildBlob(from: classifierExpansion, rows: vocabSize, cols: bottleneck)),
            ],
