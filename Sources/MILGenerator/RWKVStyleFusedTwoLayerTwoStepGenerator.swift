...
public struct RWKVStyleFusedTwoLayerTwoStepGenerator: MILProgramGenerator {
    ...
    public var outputByteSizes: [Int] { let b = ModelConfig.dim * laneSpatial * 2; return [b, b, b, b, b, b] }
    ...
    public var milText: String {
        LegacyGraphSupport.emitGraph { graph in
            ...
            let l1s0 = try LegacyGraphSupport.recurrentLayer(&graph, dim: ModelConfig.dim, lane: laneSpatial, groups: 1, layerIndex: 1, prefix: "l1s0_", inputX: l0s0.x, inputState: stateIn1, weightPrefix: "", outputXName: "x0Next", outputStateName: "stateMid1")
            ...
            let l1s1 = try LegacyGraphSupport.recurrentLayer(&graph, dim: ModelConfig.dim, lane: laneSpatial, groups: 1, layerIndex: 1, prefix: "l1s1_", inputX: l0s1.x, inputState: l1s0.state, weightPrefix: "", outputXName: "x1Next", outputStateName: "stateOut1")
            try LegacyGraphSupport.setOutputs(&graph, [("x0Next", l1s0.x), ("x1Next", l1s1.x), ("stateMid0", l0s0.state), ("stateMid1", l1s0.state), ("stateOut0", l0s1.state), ("stateOut1", l1s1.state)])
        }
    }
}
